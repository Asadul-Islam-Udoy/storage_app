...
export default function Dashboard() {
  const stats = [
    { label: "Videos", value: "132", icon: PlayCircle, color: "from-blue-500 to-indigo-500" },
    { label: "Audio", value: "89", icon: Music2, color: "from-green-500 to-emerald-400" },
    { label: "Pictures", value: "264", icon: Img, color: "from-pink-500 to-rose-500" },
