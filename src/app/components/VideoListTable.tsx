...
export default function VideoListTable({ videos, onEdit, onDelete }: Props) {
      ...
      <div className="mb-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-2">
        ...
        <div className="flex items-center justify-content-center gap-2">
          ...
          <div className="mt-4  flex justify-end ">
            <button className="bg-green-600 cursor-pointer hover:bg-green-700 text-white px-4 py-2 rounded text-sm">
              + Create Video
            </button>
          </div>
              ...
              <tr key={video.id} className="hover:bg-gray-50">
                ...
                <td className="p-2 border text-center whitespace-nowrap">
                  <button
                    ...
                    className="bg-blue-500 hover:bg-blue-600 text-white px-2 py-1 rounded mr-2 text-xs"
                  >
                    Edit
                  </button>
                  <button
